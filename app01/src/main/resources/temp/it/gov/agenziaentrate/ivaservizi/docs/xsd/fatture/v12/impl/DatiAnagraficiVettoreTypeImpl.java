 ...
 */
public class DatiAnagraficiVettoreTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v12.DatiAnagraficiVettoreType
{
    private static final long serialVersionUID = 1L;
    
    public DatiAnagraficiVettoreTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName NUMEROLICENZAGUIDA$6 = 
        new javax.xml.namespace.QName("", "NumeroLicenzaGuida");
    ...
    public java.lang.String getNumeroLicenzaGuida()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(NUMEROLICENZAGUIDA$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v12.String20Type xgetNumeroLicenzaGuida()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v12.String20Type target = null;
            target = (it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v12.String20Type)get_store().find_element_user(NUMEROLICENZAGUIDA$6, 0);
            return target;
        }
    }
     ...
     */
    public boolean isSetNumeroLicenzaGuida()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(NUMEROLICENZAGUIDA$6) != 0;
        }
    }
    ...
    public void setNumeroLicenzaGuida(java.lang.String numeroLicenzaGuida)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(NUMEROLICENZAGUIDA$6);
            }
            target.setStringValue(numeroLicenzaGuida);
        }
    }
     ...
     */
    public void xsetNumeroLicenzaGuida(it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v12.String20Type numeroLicenzaGuida)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v12.String20Type)get_store().add_element_user(NUMEROLICENZAGUIDA$6);
            }
            target.set(numeroLicenzaGuida);
        }
    }
     ...
     */
    public void unsetNumeroLicenzaGuida()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(NUMEROLICENZAGUIDA$6, 0);
        }
    }
}
